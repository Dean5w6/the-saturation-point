    ...
    <div class="col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-bottom">
                <h4 class="mb-0 font-playfair" style="color: var(--ink-blue);">Edit Category: {{ $category->name }}</h4>
            </div>
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3 text-center bg-light rounded p-4 border border-dashed">
                            @if($category->img_path)
                                <img id="cat-preview" src="{{ Storage::url($category->img_path) }}" class="shadow-sm rounded" style="width: 100%; height: 200px; object-fit: cover;">
                            @else
                                <img id="cat-preview" src="https://via.placeholder.com/400x200?text=No+Image" class="shadow-sm rounded" style="width: 100%; height: 200px; object-fit: cover;">
                            @endif
                        </div>
                        <label class="form-label small text-muted fw-bold">Change Image</label>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary text-uppercase fw-bold shadow-sm" style="border-radius: 2px; padding: 10px 25px;">Update Category</button>
                    </div>
                </form>
            </div>
        </div>
